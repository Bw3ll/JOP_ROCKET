...
**NOTE: We made an update with important new features and improved performance 5/6/2021 with v.2.12. Another smaller update with additional gadgets is planned, including two-gadget dispatcher!**
**2.12 fixes an indexing error that prematurely ended some larger binaries from being scanned all the way.**
